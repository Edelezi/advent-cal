          ...
          >
            ...
            <div className="absolute inset-0">
              {days.map((day, index) => {
                ...
                const bgColor =
                  day.backgroundColor || calendar.defaultColor || "#dc2626";
                const txtColor =
                  day.textColor || calendar.defaultTextColor || "#ffffff";
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        className="font-bold drop-shadow-md relative z-10 font-christmas"
                      ...
                      <div
                        className="absolute bottom-[70%] left-1/2 -translate-x-1/2 mb-2 hidden group-hover:flex gap-1 bg-white p-1 rounded-full shadow-md z-[100] pointer-events-auto"
                        onMouseDown={(e) => {
                          e.stopPropagation();
                          e.preventDefault();
                        }}
            ...
            <div>
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  onChange={(e) =>
                    setDay({ ...day, size: parseFloat(e.target.value) })
                  }
                  className="flex-1"
                />
                <Button
            ...
            <div>
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  onChange={(e) =>
                    setDay({ ...day, fontSize: parseFloat(e.target.value) })
                  }
                  className="flex-1"
                />
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  onClick={() => setDay({ ...day, fontSize: null })}
                >
                  Reset
                </Button>
              </div>
