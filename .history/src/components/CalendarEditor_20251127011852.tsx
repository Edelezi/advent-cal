                ...
                return (
                  ...
                  >
                    <div
                      ref={day.nodeRef}
                      className={cn(
                        "absolute flex items-center justify-center shadow-lg cursor-move transition-transform group z-20", // Removed hover:scale-110
                    ...
                    >
                      ...
                      <span
                        ...
                        style={{ color: txtColor, fontSize: "40cqw" }}
                      >
                        {day.dayNumber}
                      </span>
