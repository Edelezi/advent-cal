...
export default function CalendarEditor({ calendar }: { calendar: Calendar }) {
  ...
  const [days, setDays] = useState<Day[]>(() =>
    calendar.days.map((d) => ({ ...d, style: d.style || 'circle', nodeRef: createRef<HTMLDivElement>() }))
  );
              ...
              >
                <div
                  ...
                  className={cn(
                    ...
                    day.style === 'square' ? "bg-green-600 rounded-md" : "bg-red-600 rounded-full"
                  )}
                >
                    ...
                    {day.style === 'square' && (
                        <>
                            <div className="absolute inset-y-0 left-1/2 -translate-x-1/2 w-3 bg-red-500/80 pointer-events-none" />
                            <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 h-3 bg-red-500/80 pointer-events-none" />
                        </>
                    )}

                  <span className="font-bold text-xl drop-shadow-md text-white relative z-10">{day.dayNumber}</span>
            ...
            <div>
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="square">Present (Square)</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
