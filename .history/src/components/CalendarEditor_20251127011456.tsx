                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="absolute -top-[60%] left-1/2 -translate-x-1/2 hidden group-hover:flex gap-1 bg-white p-1 rounded-full shadow-md z-50 pointer-events-auto" onMouseDown={(e) => e.stopPropagation()}>
                        <button
