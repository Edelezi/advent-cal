...
export default function CalendarEditor({ calendar }: { calendar: Calendar }) {
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex-1 bg-gray-100 overflow-auto p-8 flex justify-center items-center">
        <div 
                ...
                <div className="absolute inset-0">
                    {days.map((day, index) => {
                        ...
                        >
                            ...
                            ref={day.nodeRef}
                            className={cn(
                                "absolute flex items-center justify-center shadow-lg cursor-move transition-transform group z-20",
                            ...
                            <span
                                className="font-bold drop-shadow-md relative z-10"
                                style={{ color: txtColor, fontSize: `${fontSize}cqw` }}
                            >
                                {day.dayNumber}
                            </span>
                            {/* Edit Menu - Absolute positioned relative to the day item */}
                            <div
                                className="absolute bottom-[100%] left-1/2 -translate-x-1/2 mb-2 hidden group-hover:flex gap-1 bg-white p-1 rounded-full shadow-md z-[100] pointer-events-auto"
                                onMouseDown={(e) => {
                                    e.stopPropagation();
                                    e.preventDefault();
                                }}
      ...
      <DayDialog
        ...
        defaultSize={calendar.defaultSize}
        defaultFontSize={calendar.defaultFontSize}
      />
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <Input
                        ...
                        id="defaultSize"
                        name="defaultSize"
                        defaultValue={calendar.defaultSize || 6.5}
                    />
                </div>
                <div>
                    <Label htmlFor="defaultFontSize">Default Font Size (cqw)</Label>
                    <Input
                        type="number"
                        step="1"
                        id="defaultFontSize"
                        name="defaultFontSize"
                        defaultValue={calendar.defaultFontSize || 40}
                    />
                </div>
            </div>
            ...
            <div>
                ...
                <div className="flex gap-2">
                    <Input
                        type="number"
                        step="0.1"
                        value={day.size || defaultSize || 6.5}
                        onChange={(e) => setDay({ ...day, size: parseFloat(e.target.value) })}
                        className="flex-1"
                    />
                    <Button type="button" variant="outline" size="sm" onClick={() => setDay({ ...day, size: null })}>Reset</Button>
                </div>
            </div>
            <div>
                ...
                <div className="flex gap-2">
                    <Input
                        type="number"
                        step="1"
                        value={day.fontSize || defaultFontSize || 40}
                        onChange={(e) => setDay({ ...day, fontSize: parseFloat(e.target.value) })}
                        className="flex-1"
                    />
                    <Button type="button" variant="outline" size="sm" onClick={() => setDay({ ...day, fontSize: null })}>Reset</Button>
                </div>
            </div>
          </div>
