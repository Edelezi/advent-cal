...
import { Lock, Music, Image as ImageIcon, AlignLeft, Check } from 'lucide-react';
...
export default function CalendarDisplay({
  ...
  const markDayAsOpened = (dayId: string) => {
    if (!openedDays.includes(dayId)) {
      ...
      localStorage.setItem(`calendar_${calendar.id}_opened`, JSON.stringify(newOpened));
    }
  };
    ...
    >
      <div
        className={cn(
          ...
          isOpened && "opacity-50 border-2 border-white/50" // Dim opened days
        )}
        style={{
