...
function DayItem({
  ...
  const isDecember = true; //today.getMonth() === 11;
  const canOpen = isTest || (isDecember && 1 >= day.dayNumber);
    ...
    >
      <div
        className={cn(
          ...
          !canOpen && "grayscale-[0.5]" // Removed opacity-80 to let backdrop-filter work better
        )}
        style={{
          ...
          WebkitBackdropFilter: !canOpen ? "blur(10px)" : "none", // Safari support
        }}
      >
