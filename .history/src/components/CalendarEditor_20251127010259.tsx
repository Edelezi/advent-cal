          ...
          {days.map((day, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  {/* Visual embellishments for styles */}
                  {dayStyle === "circle" && (
                  ...
                  {/* Simple square: no embellishment, just color and shape */}

                  <span className="font-bold text-xl drop-shadow-md relative z-10" style={{ color: txtColor }}>
                    {day.dayNumber}
                  </span>
          ...
          <form onSubmit={saveSettings} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <Select name="defaultStyle" defaultValue={calendar.defaultStyle}>
                        <SelectTrigger>
                ...
                <div>
                    ...
                    <div className="flex gap-2">
                        <Input type="color" id="defaultColor" name="defaultColor" defaultValue={calendar.defaultColor || '#dc2626'} className="w-12 p-1 h-10" />
                        <Input type="text" defaultValue={calendar.defaultColor || '#dc2626'} onChange={(e) => {
                            const val = e.target.value;
                            (document.getElementById('defaultColor') as HTMLInputElement).value = val;
                        }} className="flex-1" />
                    </div>
                </div>
                 <div>
                    ...
                    <div className="flex gap-2">
                        <Input type="color" id="defaultTextColor" name="defaultTextColor" defaultValue={calendar.defaultTextColor || '#ffffff'} className="w-12 p-1 h-10" />
                         <Input type="text" defaultValue={calendar.defaultTextColor || '#ffffff'} onChange={(e) => {
                            const val = e.target.value;
                            (document.getElementById('defaultTextColor') as HTMLInputElement).value = val;
                        }} className="flex-1" />
                    </div>
                </div>
            </div>
...
function DayDialog({ open, onOpenChange, day, setDay, onSave, isSaving, defaultColor, defaultTextColor }: any) {
  if (!day) return null;
             ...
             <div>
                ...
                <div className="flex gap-2">
                    <Input 
                        ...
                        onChange={(e) => setDay({ ...day, backgroundColor: e.target.value })} 
                        className="w-12 p-1 h-10"
                    />
                    <Button type="button" variant="outline" size="sm" onClick={() => setDay({ ...day, backgroundColor: null })}>Reset</Button>
                </div>
            </div>
            <div>
                ...
                <div className="flex gap-2">
                    <Input 
                        ...
                        onChange={(e) => setDay({ ...day, textColor: e.target.value })} 
                        className="w-12 p-1 h-10"
                    />
                    <Button type="button" variant="outline" size="sm" onClick={() => setDay({ ...day, textColor: null })}>Reset</Button>
                </div>
            </div>
          </div>
