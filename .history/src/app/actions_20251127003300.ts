...
export async function verifyCalendarPassword(calendarId: string, passwordAttempt: string) {
...
export async function saveDay(calendarId: string, dayData: any) {
  const { id, dayNumber, content, contentType, positionX, positionY } = dayData;
